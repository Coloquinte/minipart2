...
void Hypergraph::writeMinipart(ostream &s) const {
  // Minipart format is:
  // % Comment
  // nNodes nHedges nParts
  // nNodeWeights nHedgeWeights nPartWeights
  // % nHedges lines with the pins for each hyperedge
  // % nHedges lines with the weights for each hyperedge
  // % nNodes lines with the weights for each node
  // % nParts lines with the weights for each part
